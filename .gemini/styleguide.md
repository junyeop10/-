...
상세: `backend/docs/CONVENTIONS.md`, Git 워크플로: `rules/GITHUB_BEGINNER.md`
...
- `EvidencePackage`, `ClassifyResult`, `Category` 등은 **`backend/models/schemas.py` 에만 정의**
...
- 팀 키워드는 `backend/config/keywords.json` — `stage1_evidence.py`에 키워드 하드코딩 추가 지양
